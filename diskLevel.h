...
public:
    ...
    class Heap{
        ...
        Heap(int sz, KVIntpair_t mx):size(sz),arr(sz,mx),max(mx){
    ...
    diskLevel<K, V>(unsigned pageSize, int level, ull runSize, unsigned runNum, unsigned mergeSize, double bf_fp);
